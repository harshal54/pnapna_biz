		...
		<div class="form-right">
			...
			<div class="row">
				...
				<div class="form-group col-md-12 text-center">
					<button type="submit" class="btn btn-medium btn--dark btn-hover-shadow" style="margin-bottom:15px">Sign In</button>
				</div>
				<div class="col-md-6 col-sm-6 col-xs-12">
					<a href="<?php echo base_url('forget-password');?>" class="helped">Lost your password?</a>
				</div>
				<div class="col-md-6 col-sm-6 col-xs-12">
					<a href="<?=base_url('signup')?>" class="helped">Register Now</a>
				</div>
			</div>
			<?php echo form_close();?>
		</div>
