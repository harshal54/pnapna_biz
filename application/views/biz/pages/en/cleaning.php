...
<div class="content-wrapper">
	...
	<div class="stunning-header stunning-header-bg-breez24">
		<div class="stunning-header-content">
			<h1 class="stunning-header-title" style="color: white">Cleaning</h1>
			<ul class="breadcrumbs" >
				...
				<li class="breadcrumbs-item active">
					<span style="color: white">Cleaning</span>
				...
				<div class="row">
					<div class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-12 col-xs-12">
						<div class="heading align-center pb120">
							<h4 class=" heading-title" style="font-size: 42px">Cleaning is About Bringing Customers
										...
										<div class="testimonial-item testimonial-arrow mb30">
											...
											<div class="author-info-wrap table">
												<div class="testimonial-img-author table-cell">
													<img src="<?=base_url()?>assets/biz/img/avatar3.png" alt="author">
												</div>
