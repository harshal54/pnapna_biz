...
<div class="content-wrapper">
	...
	<div class="stunning-header stunning-header-bg-breez25">
		<div class="stunning-header-content">
			<h1 class="stunning-header-title" style="color: white">
					...
					<form class="contact-form" method="post" action="send_mail.php">
						<div class="row">
							...
							<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
								...
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
										<input name="zipcode" class="email input-standard-grey" required placeholder="Zipcode" type="number">
									</div>
									<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
										<input name="trade" class="email input-standard-grey" placeholder="Trade Served" type="text">
									</div>
								</div>
							</div>
