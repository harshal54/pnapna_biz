...
<div class="content-wrapper">
	...
	<div class="stunning-header stunning-header-bg-breez30">
		<div class="stunning-header-content">
			<h1 class="stunning-header-title" style="color: white">Other Portals</h1>
			<ul class="breadcrumbs" >
				...
				<li class="breadcrumbs-item active">
					<span href="#" style="color: white">Other Portals</span>
