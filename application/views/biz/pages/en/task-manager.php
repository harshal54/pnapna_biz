...
<div class="content-wrapper">
	...
	<div class="stunning-header stunning-header-bg-breez23">
		<div class="stunning-header-content">
			<h1 class="stunning-header-title c-dark" style="color: white">Task Manager</h1>
			<ul class="breadcrumbs">
				<li class="breadcrumbs-item">
					<a href="<?=base_url()?>" class="c-gray">Home</a>
					<i class="seoicon-right-arrow"></i>
				</li>
				<li class="breadcrumbs-item active">
					<span href="#" class="c-primary">Task Manager
</span>
					<i class="seoicon-right-arrow"></i>
				</li>
			</ul>
