...
<div class="content-wrapper">
	...
	<div class="stunning-header stunning-header-bg-breez28">
		<div class="stunning-header-content">
			<h1 class="stunning-header-title" style="color: white">Partnership Enrolment</h1>
			<ul class="breadcrumbs" >
				...
				<li class="breadcrumbs-item active">
					<span href="#" style="color: white">Partnership Enrolment</span>
					<i class="seoicon-right-arrow"></i>
				</li>
			</ul>
		</div>
