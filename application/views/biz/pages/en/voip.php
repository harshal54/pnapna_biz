...
<div class="content-wrapper">
	...
	<div class="stunning-header stunning-header-bg-red">
		<div class="stunning-header-content" style="max-width:100%">
			<h2 class="stunning-header-title" style="color: white">
				Sit tight.
			</h2>
			<h2 class="stunning-header-title" style="color: white">
				We are redoing this webpage. It shall be done soon
			</h2>
		</div>
	</div>
