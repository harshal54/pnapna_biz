...
<div class="content-wrapper">
	...
	<div class="stunning-header stunning-header-bg-breez29">
		<div class="stunning-header-content">
			<h1 class="stunning-header-title1">Help Desk</h1>
	...
	<div class="container">
		<div class="row pt120">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="heading">
					<h4 class="h1 heading-title">Tell Us About Your Company</h4>
					<div class="heading-line">
						<span class="short-line"></span>
						<span class="long-line"></span>
					</div>

					<p>Let us help you get use our professional Help Desk.
					</p>
				</div>
			</div>
		</div>
