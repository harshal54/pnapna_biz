...
<div class="content-wrapper">
	...
	<div class="stunning-header stunning-header-bg-breez27">
		<div class="stunning-header-content">
			<h1 class="stunning-header-title" style="color: white">Comparisons</h1>
			<ul class="breadcrumbs" >
				...
				<li class="breadcrumbs-item active">
					<span style="color: white">Comparisons</span>
