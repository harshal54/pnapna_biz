<div class="wrapper">
	<svg xmlns="http://www.pnapna.com/svg" viewBox="0 0 1920 1080">
		<title>404</title>
	...
	<div style="text-align: center;font-family: cursive;">
		<h1 style="margin-top: 0px;color: #4e4066;margin-bottom: 0px"><?php echo $heading; ?></h1>
		<h4 style="margin-top: 0px;color: #4e4066;margin-top: 0px"><?php echo $message; ?></h4>
		<a href="https://pnapna.com">
			<button style="background-color: #6f5b92;border: solid 1px #4e4066;padding: 5px 10px;border-radius: 4px;color: #fff;cursor: pointer;">Go to Home</button>
		</a>
	</div>
</div>
